...
public class BlockChain 
{
    ...
    private HashMap<ByteArrayWrapper, BlockNode> mBlockChain;
    private BlockNode mMaxHeightNode;
    private TransactionPool mTxPool;
    ...
    public BlockChain(Block genesisBlock) 
    {
        ...
        mBlockChain = new HashMap<>();
        UTXOPool utxoPool = new UTXOPool();
        addCoinbaseToUTXOPool(genesisBlock, utxoPool);
        BlockNode genesisNode = new BlockNode(genesisBlock, null, utxoPool);
        mBlockChain.put(wrap(genesisBlock.getHash()), genesisNode);
        mTxPool = new TransactionPool();
        mMaxHeightNode = genesisNode;
    }
    ...
    public UTXOPool getMaxHeightUTXOPool() 
    {
        ...
        return mMaxHeightNode.getUTXOPoolCopy();
    }
    ...
    public boolean addBlock(Block block) 
    {
        ...
        BlockNode parentBlockNode = mBlockChain.get(wrap(prevBlockHash));
        ...
        if (proposedHeight <= mMaxHeightNode.height - CUT_OFF_AGE) return false;
        ...
        mBlockChain.put(wrap(block.getHash()), node);
        
        if (proposedHeight > mMaxHeightNode.height) mMaxHeightNode = node;
